...
export default class BranchService {
    ...
    /**
     * Filters branches based on provided options with optional pagination.
     *
     * @param {Object} [props] - The options for filtering branches.
     * @param {string} [props.filters] - The filters to apply for exporting branches.
     ...
     * @returns {Promise<BranchResource>} - The response containing the updated company resource.
     */
    public static async ProfilePicture(
        ...
        const response = await UseServer.post<MediaRequest, BranchResource>(
            endpoint,
            data
        )
        return response.data

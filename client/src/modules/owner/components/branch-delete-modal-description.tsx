const BranchDeleteModalContent = () => {
    return (
        <div className="space-y-4 text-sm text-gray-200">
            <div className="space-y-4">
                ...
                <p>
                    Upon initiating the deletion request, all branch-related
                ...
                <ul className="list-disc space-y-1 pl-6">
                    <li>
                        ...
                        payments, invoices, or refunds linked to this branch.
                    </li>
                    <li>
                        Disabling all automated processes like recurring
                        billing, notifications, and scheduled tasks associated
                        with this branch.
                    </li>
                    <li>
                        Termination of third-party integrations linked to this
                        branch account.
                    </li>
                    <li>
                        Restricted access for users, employees, and
                        administrators to branch-related data.
                    </li>
                </ul>
            </div>
            ...
            <ul className="list-disc space-y-1 pl-6">
                <li>
                    The branch account will remain in a <em>suspended state</em>
                    , and no operations or transactions can take place.
                </li>
                <li>
                ...
                <li>
                    ...
                    "Cancel Deletion" button, fully restoring the branch and its
                    functionalities without any data loss.
                </li>
            </ul>
            ...
            <p>
                ...
                the branch will be <strong>permanently deleted</strong>.
            </p>
...
export default BranchDeleteModalContent

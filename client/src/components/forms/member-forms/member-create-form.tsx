...
interface IMemberCreateFormProps
    extends IBaseCompNoChild,
        IForm<Partial<IMemberRequest>, unknown, string> {}
...
const MemberCreateForm = ({
    ...
    const form = useForm<TMemberCreateForm>({
...
export const MemberCreateFormModal = ({
    title = 'Create Member',
    description = 'Fill out the form to add a new member.',
    className,
    formProps,
    ...props
}: IModalProps & { formProps?: Omit<IMemberCreateFormProps, 'className'> }) => {
    return (
        <Modal
            title={title}
